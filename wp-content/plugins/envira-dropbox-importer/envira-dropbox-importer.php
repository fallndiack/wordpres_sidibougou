<?php
/**
 * Plugin Name: Envira Gallery - Dropbox Importer Addon
 * Plugin URI:  http://enviragallery.com
 * Description: Enables Dropbox image importing directly into Envira Galleries
 * Author:      Envira Gallery Team
 * Author URI:  http://enviragallery.com
 * Version:     1.3.3
 * Text Domain: envira-dropbox-importer
 * Domain Path: languages
 *
 * @package Envira Dropbox Importer
 * @subpackage Envira Dynamic
 *
...
class Envira_Dropbox_Importer {
	 ...
	 * @var string
	 */
	public $plugin_name = 'Envira Dropbox Importer';
	 ...
	 * @var string
	 */
	public $plugin_slug = 'envira-dropbox-importer';
	...
	public function require_admin() {
		...
		require plugin_dir_path( __FILE__ ) . 'includes/admin/dropbox.php';
	 ...
	 * @since 1.0.0
	 *
	 * @return object The Envira_Dropbox_Importer object.
	 */
	public static function get_instance() {

		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Envira_Dropbox_Importer ) ) {
			self::$instance = new Envira_Dropbox_Importer();
		}
...
$envira_dropbox_importer = Envira_Dropbox_Importer::get_instance();
