	...
	function( $ ) {
			...
			$( '#envira-albums-settings input:not([type=hidden]), #envira-albums-settings select, #envira-gallery-settings input:not([type=hidden]), #envira-gallery-settings select' ).conditions(
				...
				{  // Main Tag Elements
					...
					actions: {
						if : {
							element: '#envira-config-tags-position, #envira-config-tags-filtering-box, #envira-config-tags-all-enabled-box, #envira-config-tags-all-box, #envira-config-tags-sorting-box, #envira-config-tags-display-box, #envira-config-tags-scroll-box, #envira-config-tags-count-box, #envira-config-exif-tags-box',
							action: 'show'
						},
						else : {
							element: '#envira-config-tags-position, #envira-config-tags-filtering-box, #envira-config-tags-all-enabled-box, #envira-config-tags-all-box, #envira-config-tags-sorting-box, #envira-config-tags-display-box, #envira-config-tags-scroll-box, #envira-config-tags-count-box, #envira-config-exif-tags-box',
