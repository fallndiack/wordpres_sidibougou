...
if ( version_compare( PHP_VERSION, '5.6.0', '<' ) ) {
	...
	wp_die( sprintf( esc_html__( 'Envira Gallery requires PHP 5.3 or higher. You\'re still on PHP %s. Please contact your web host for more information on how to upgrade your PHP version.', 'Envira Gallery' ), esc_url( get_admin_url() ) ) );
